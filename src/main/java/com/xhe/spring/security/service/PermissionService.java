...
import com.xhe.spring.security.common.exception.SecurityException;
...
//            List<Permission> permissions = permissionDao.selectByRoleIdList(roleIds);
            ...
            per.setId(1072806379313565696L);
            per.setMethod("GET");
            per.setType(2);
            per.setName("测试页面-查询");
            per.setParentId(1072806379288399872L);
            per.setUrl("/user/test");
            List<Permission> permissions = Arrays.asList(per);
